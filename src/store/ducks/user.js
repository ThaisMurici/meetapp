...
export const reducer = createReducer(INITIAL_STATE, {
  ...
  [Types.LOAD_USER_SUCCESS]: (state, { user }) => state.merge({ data: user, loading: false }),
  ...
  [Types.UPDATE_USER_SUCCESS]: (state, { user }) => state.merge({ data: user, loading: false }),
  [Types.UPDATE_USER_FAILURE]: state => state.merge({ error: true, loading: false }),
});
